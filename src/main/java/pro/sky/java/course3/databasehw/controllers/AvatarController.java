...
import pro.sky.java.course3.databasehw.service.AvatarService;
import pro.sky.java.course3.databasehw.service.AvatarServiceimpl;
...
public class AvatarController {
    ...
    public ResponseEntity<byte[]> downloadAvatar(@PathVariable Long id) {
        ...
        headers.setContentLength(avatarService.getData().length);
